  ...
  return (
    ...
    >
      <div className="max-h-screen flex items-center justify-start pt-48  md:pt-48 flex-col px-4 md:px-20 xl:px-40 gap-4">
        <p className="flex items-center gap-2 text-sm text-white font-medium text-center border border-secondary/20 rounded-full px-8 py-2 uppercase">
          Built for Pakistani students applying abroad for Masters programs
        </p>

        <h1 className="text-4xl md:text-5xl lg:text-6xl tex leading-[1.15] max-w-[900px] font-semibold text-gray-100 text-center">
          Increase Your Chances of Scholarships & Masters Admissions Abroad
        </h1>

        <p className="text-base font-body md:text-xl text-gray-100 text-center max-w-[800px]">
