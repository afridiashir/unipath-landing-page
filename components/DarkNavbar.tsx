    ...
    <>
      ...
      <div className="absolute top-0 left-0 right-0 hidden lg:flex items-center justify-between h-[80px] px-36 xl:px-64">
        <div className="flex items-center gap-16">
          <Link
            href="/"
            className="font-heading text-2xl font-semibold hover:text-secondary text-white"
          >
            UniPath
          </Link>
...
const DesktopNavItem = ({
  ...
  return (
    <div className="relative group">
      <Link
        href={item.href}
        className="flex text-base text-white items-center gap-1 px-3 py-2 font-medium hover:text-secondary transition-colors"
      >
        {item.label}
